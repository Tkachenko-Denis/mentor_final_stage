...
# Добавил возможность просмотра выполненных задач
...
# Добавил возможность просмотра невыполненных задач
...
# Добавил возможность просмотра статистики задач
@app.get("/items/stats")
def get_stats(db: Session = Depends(get_db)):
    total = db.query(TodoItemModel).count()
    completed = db.query(TodoItemModel).filter(TodoItemModel.completed == True).count()
